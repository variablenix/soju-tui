...
func TestDiscoverSojuConfigFindsChatListener(t *testing.T) {
	...
	if discovered.Server != "172.32.0.1:6697" || !discovered.TLS || discovered.TLSServerName != "soju.example.com" {
...
func TestProfileRoundTripDoesNotRequirePassword(t *testing.T) {
	...
	tlsEnabled := true
	want := SavedProfile{Server: "soju.example.com:6697", TLS: &tlsEnabled, Username: "ak"}
